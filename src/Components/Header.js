...
class Header extends Component {
    render() {
        ...
        const description =
            'Esta é a página que fizemos especialmente para o evento, aqui você vai encontrar informações sobre como adquirir convites gratuitos e vai poder ouvir playlists especiais';
